 ...
 *     }); 
 */
Ext.define('Gm.view.grid.filter.DateTime', {
    extend: 'Ext.grid.filters.filter.TriFilter',
    alias: 'grid.filter.datetime',
    uses: ['Gm.view.picker.DateTimePicker', 'Ext.menu.Menu'],
    ...
    createMenu: function (config) {
        ...
        for (i = 0, len = menuItems.length; i < len; i++) {
            ...
            if (key !== '-') {
                ...
                // Date filter types need the field to be the datetimepicker in TriFilter.setValue(). 
                field = me.fields[key] = item.down('datetimepicker');
    ...
    */
    onCheckChange: function (field, checked) {
        ...
        var filter = field.down('datetimepicker').filter,
            v;
