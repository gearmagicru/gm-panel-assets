/**
 * @class Gm.view.portal.DropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Gm.view.portal.Portal}.
 */
Ext.define('Gm.view.portal.DropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Gm.view.portal.DropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        Gm.view.portal.DropZone.superclass.unreg.call(this);
